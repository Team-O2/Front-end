...
import { MoreClickedIcon, MoreIcon, NextIcon, PrevIcon } from 'public/assets/images';
    ...
    <CategoryListWrapper>
      <Main>
        {(!localVisible || animation) && (
          <PrevButton disappear={!!currentSlide}>
            <Image src={PrevIcon} onClick={handlePrev} alt="" />
          </PrevButton>
        )}
        ...
        <Shadow />
        <NextButton>
          <Image src={NextIcon} onClick={handleNext} alt="" />
        </NextButton>
        <Image src={isMoreClicked ? MoreClickedIcon : MoreIcon} onClick={onClickOpenMore} alt="" />
      </Main>
      <div>
        {isOpenMore && (
          <More>
