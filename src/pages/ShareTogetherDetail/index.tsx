...
import TShareTogetherDetail from 'components/templates/ShareTogetherDetail';
const mockData = [
  {
    concertId: '1',
    image: test,
...
function ShareTogetherDetail({ match }: RouteComponentProps<MatchParams>): React.ReactElement {
  ...
  return <TShareTogetherDetail selectedConcert={selectedConcert}></TShareTogetherDetail>;
}
