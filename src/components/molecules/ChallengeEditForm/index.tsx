...
interface IProps {
  handleTotalOnChange: (e: React.ChangeEvent<HTMLTextAreaElement>) => void;
  byte: IByte;
  ITextForm: ITextForm;
}

function ChallengeEditForm({ handleTotalOnChange, byte, ITextForm }: IProps): React.ReactElement {
